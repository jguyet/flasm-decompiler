...
import com.flasm.action.conversion.ASDecompileConversionActionManager;
import com.flasm.action.conversion.PCODEDecompileConversionActionManager;

public class FlasmDecompileActionFactory {
	...
	static//load once
	{
		Method[] allASmethods = ASDecompileConversionActionManager.class.getDeclaredMethods();
		Method[] allFLASMmethods = PCODEDecompileConversionActionManager.class.getDeclaredMethods();
